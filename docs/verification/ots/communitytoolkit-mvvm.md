...
**DockTests.CreateLayout_ComposesFourPanelDockables**: Constructing the real `PredefinedViewsToolViewModel`, `CustomViewBuilderToolViewModel`, and `DiagnosticsToolViewModel` instances and composing them into a Dock layout proves the CommunityToolkit.Mvvm-generated observable properties compile and function as genuine Dock dockables.
